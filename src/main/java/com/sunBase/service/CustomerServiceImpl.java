...
public class CustomerServiceImpl implements CustomerServices {
    ...
    public Customer getCustomerBy_id(String id) {
        ...
        if (customer.isEmpty()) {
            throw new CustomerException("This customer is not present in the database.");
        }
        return customer.get();
    }
    ...
    public String createCustomer(Customer customer) {
        ...
        if (existingCustomer.isPresent()) {
            throw new CustomerException("This customer is already present in the database.");
        }
    ...
    private void updateCustomerDetails(final Customer existingCustomer, final Customer newDetails) {
        ...
        if (newDetails.getLast_name() != null && !newDetails.getLast_name().isBlank()) {
            existingCustomer.setLast_name(newDetails.getLast_name());
        }
    ...
    public Page<Customer> searchAndFilterCustomers(String searchTerm, String city, String state, String email, Pageable pageable) throws CustomerException {
        ...
        if (customers.isEmpty()) {
            throw new CustomerException("No customer found with the given criteria.");
        }
        return customers;
    }
}
